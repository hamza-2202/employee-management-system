...
function Create() {
  ...
  const handleSubmit = async (e) => {
    ...
    response ? navigate("/") : alert(`Something went wrong`)
  };
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center">
          <label className="pb-2 pe-2">Employee Name:</label>
          <input
        ...
        <div className="flex items-center">
          <label className="pb-2 pe-2">Employee Email:</label>
          <input
            className="border border-gray-400 rounded p-1 mt-1 mb-2 grow bg-gray-50"
            type="text"
            name="email"
        ...
        <div className="flex items-center">
          <label className="pb-2 pe-2">Employee Department:</label>
          <input
            className="border border-gray-400 rounded p-1 mt-1 mb-2 grow bg-gray-50"
            type="text"
            name="department"
        ...
        <div className="flex items-center">
          <label className="pb-2 pe-2">Employee Position:</label>
          <input
            className="border border-gray-400 rounded p-1 mt-1 mb-2 grow bg-gray-50"
            type="text"
            name="position"
        ...
        <div className="flex items-center">
          <label className="pb-2 pe-2">Employee Salary:</label>
          <input
            className="border border-gray-400 rounded p-1 mt-1 mb-2 grow bg-gray-50"
            type="text"
            name="salary"
        ...
        <div className="flex items-center">
          <label className="pb-2 pe-2">Employee Address:</label>
          <input
            className="border border-gray-400 rounded p-1 mt-1 mb-2 grow bg-gray-50"
            type="text"
            name="address"
